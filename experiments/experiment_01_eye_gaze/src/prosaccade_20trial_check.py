...
def main():
    ...
    print("Phase 1C — Full 20-Trial Prosaccade Integration")
    print("=" * 50)
    ...
    print("\nFull randomized trials sequence:")

    trial_sequence = full_sequence
    ...
    iti_sequence = full_iti_sequence
