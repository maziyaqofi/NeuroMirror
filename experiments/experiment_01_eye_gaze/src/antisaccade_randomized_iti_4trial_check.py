...
def main():
    ...
    print("Phase 1C.24 — 4-Trial Randomized Antisaccade")
    print("=" * 50)
    ...
    full_sequence, generation_attempts = generate_balanced_sequence(
    ...
    print("\nFirst 4 randomized trials:")

    trial_sequence = full_sequence[:4]

    full_iti_sequence = generate_random_iti_sequence(
        num_trials=20,
    ...
    iti_sequence = full_iti_sequence[:4]
    ...
    print("\nFirst 4 randomized antisaccade trials:")
    print("-" * 60)
