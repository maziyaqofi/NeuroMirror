...
def run_fixation(
    ...
    # Prepare fixation stimulus.
    fixation.draw()

    # Log onset using the shared experiment clock
    # when the next display flip occurs.
    win.callOnFlip(
        logger.log_event,
    ...
    # Present a blank frame.
    # The fixation offset event is synchronized
    # with this display flip.
    win.callOnFlip(
        logger.log_event,
...
def main():
    ...
    print("Phase 1C — Flip-Synchronized Fixation Events")
    print("=" * 50)
    ...
    # Shared clock for the complete run.
