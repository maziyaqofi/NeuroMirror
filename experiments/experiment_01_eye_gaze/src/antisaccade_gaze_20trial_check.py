...
def main():
    ...
    print(
        "\n=== NeuroMirror Phase 1G.1 — 20-Trial Randomized Antisaccade + Gaze ==="
    )
    ...
    instruction = visual.TextStim(
        ...
        text=(
            ...
            "If the dot appears on the LEFT,\n"
            "look to the empty RIGHT side.\n\n"
            "If the dot appears on the RIGHT,\n"
            "look to the empty LEFT side.\n\n"
            "DO NOT look at the dot.\n"
            "Move your eyes in the OPPOSITE direction.\n\n"
